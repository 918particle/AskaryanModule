...
plot "ZHS/shower_100000.0_-0.3_ZHS.dat" w lp pt 2 lc -1 title "ZHS, 0.1 EeV, {/Symbol D}{/Symbol Q} = -0.3 deg", "RalstonBuniy/shower_100000.0_-0.3_JCAC.dat" w lp pt 6 lc -1 title "JCAC, 0.1 EeV, {/Symbol D}{/Symbol Q} = -0.3 deg"